...
<div class="navbar">
    <div class="nav">
        <ul>
            ...
            <li><a href="/ingresar/paciente">Ingresar Paciente</a></li>
            <li><a href="/ingresar/psicologo">Ingresar Psicologo</a></li>
            <li><a href="/registrar/sesion">Registrar Sesion</a></li>
