...
public class PsicologoRequestDraw extends Psicologo {
    private Request request;

    public PsicologoRequestDraw(Request request) throws ParseException {
        ...
        super.setEspecialidad(this.request.queryParams("especialidad"));
